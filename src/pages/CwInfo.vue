    ...
    <div class="zhuti">
      ...
      <div class="info">
          ...
          <el-popover placement="top-start" title="宠物简介" :width="200" trigger="hover"
            ...
            <template #reference>
              <div class="demo-image__lazy">
                <el-image v-for="url in result.cw.imgArr" :key="url" :src="url" lazy />
              </div>
            </template>
          </el-popover>
        </div>
        <div class="middle">
          ...
          <p>宠物剩余食物: <el-button @click="addFood(result.cw.state)" type="plain" text>{{result.cw.alsoFoodtian}}</el-button>
          </p>
...
let result = reactive({
  cw:{name:'',state:false,intro:'',alsoFoodtian:'',imgArr:[]},
